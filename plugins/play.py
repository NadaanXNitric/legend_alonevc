...
def cb_admin_check(func: Callable) -> Callable:
    async def decorator(client, cb):
        ...
        await cb.answer("𝐘𝐨𝐮 𝐀𝐢𝐧'𝐭 𝐀𝐥𝐥𝐨𝐰𝐞𝐝❗", show_alert=True)
        return
...
async def play(_, message: Message):
    ...
    try:
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                await lel.edit(
                    "<b>𝐀𝐝𝐝 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 𝐅𝐢𝐫𝐬𝐭 𝐔𝐬𝐢𝐧𝐠 /userbotjoin & /join 𝐂𝐨𝐦𝐦𝐚𝐧𝐝</b>",
                )
                try:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id,
                        "** 𝐇𝐞𝐲 𝐌𝐲 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 𝐈𝐬 𝐉𝐨𝐢𝐧𝐞𝐝.. 𝐇𝐮𝐫𝐫𝐞𝐲 🐬🤞**",
                    )
    ...
    try:
        ...
        await lel.edit(
            f"<i>𝐇𝐞𝐲 {user.first_name}, 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 𝐈𝐬 𝐍𝐨𝐭 𝐇𝐞𝐫𝐞 , 𝐒𝐞𝐧𝐝 /join 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐅𝐢𝐫𝐬𝐭 𝐓𝐨 𝐀𝐝𝐝 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭</i>"
        )
        return
